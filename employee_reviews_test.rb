...
class EmployeeReviewTest < Minitest::Test
  ...
  def test_employee_object
    dave = Employee.create(name: "Dave", email: "dave@dave.com", phone: "336-336-3636", salary: 70000)
    assert dave
  end

  def test_department_object
    logistics = Department.create(name: "Logistics")
    assert logistics
  end
  ...
  def test_employee_takes_4
    assert_raises(ArgumentError) do
      Employee.create("karl", "karl@karl.com", "545-454-5555")
    end
  end
  ...
  def test_add_total_salary
    dave = Employee.create(name: "Dave", email: "dave@dave.com", phone: "336-336-3636", salary: 70000)
    karl = Employee.create(name: "karl", email: "karl@karl.com", phone: "545-454-5555", salary: 50000)
    logistics = Department.create(name: "Logistics")
    logistics.add_employee(dave)

    assert_equal 70000, logistics.salary

    logistics.add_employee(karl)
    assert_equal 120000, logistics.salary
  end
  ...
  def test_give_raise
    dave = Employee.create(name: "Dave", email: "dave@dave.com", phone: "336-336-3636", salary: 70000)
    dave.positive_review(true)
    assert_equal 75000, dave.give_raise(5000)
  end
  ...
  def test_employee_in_dept_raise
    ...
    karl = Employee.create(name: "karl", email: "karl@karl.com", phone: "545-454-5555", salary: 50000)
    karl.positive_review(false)
    mark = Employee.create(name: "Mark", email: "mark@mark.com", phone: "545-444-5555", salary: 30000)
  ...
  #   dave = Employee.create(name: "Dave", phone: "336-336-3636", salary: 70000)
  #   karl = Employee.create(name: "karl", phone: "545-454-5555", salary: 50000)
  #   mark = Employee.create(name: "Mark", phone: "545-444-5555", salary: 30000)
  #
  #   assert_equal "dave@dave.com", dave.email
  ...
  #   dave = Employee.create(name: "Dave", email: "dave@dave.com", phone: "444-333-33d333", salary: 70000)
  #   karl = Employee.create(name: "karl", email: "karl@karl.om", phone: "545-454-5555", salary: 50000)
  #   mark = Employee.create(name: "Mark", email: "markmark.com", phone: "545-4434-5555", salary: 30000)
  #
  ...
  def test_complete_example
    ...
    logistics = Department.create(name: "Logistics")
    customer_service = Department.create(name: "Customer Service")
    ...
    assert_in_delta 81000.82, customer_service.salary, 0.01

    joey = Employee.create(name: "joey", email: "joey@joe.net", phone: "444-333-3333", salary: 30000)

    customer_service.add_employee(joey)

    assert_in_delta 111000.82, customer_service.salary, 0.01
  ...
  def test_decipher_review
    ...
    karl = Employee.create(name: "Karl", email: "karl@karl.com", phone: "545-454-5555", salary: 50000)
    mark = Employee.create(name: "Mark", email: "mark@mark.com", phone: "545-444-5555", salary: 30000)
    wanda = Employee.create(name: "Wanda", email: "wanda@wanda.net", phone: "444-333-2233", salary: 50500)
